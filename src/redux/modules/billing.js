...
const ON_CHANGE_CITY = 'billing/ON_CHANGE_CITY';
const ON_CHANGE_ADDRESS = 'billing/ON_CHANGE_ADDRESS';
const ON_CHANGE_NAME = 'billing/ON_CHANGE_NAME';
const ON_CHANGE_STATE = 'billing/ON_CHANGE_STATE';
const ON_CHANGE_PINCODE = 'billing/ON_CHANGE_PINCODE';
const ON_CHANGE_PHONE = 'billing/ON_CHANGE_PHONE';
const ON_CHANGE_EMAIL = 'billing/ON_CHANGE_EMAIL';

const SET_NAME_ERROR = 'billing/SET_NAME_ERROR';
const SET_PINCODE_ERROR = 'billing/SET_PINCODE_ERROR';
const SET_PHONE_ERROR = 'billing/SET_PHONE_ERROR';
const SET_ADDRESS_ERROR = 'billing/SET_ADDRESS_ERROR';
const SET_CITY_ERROR = 'billing/SET_CITY_ERROR';
const SET_STATE_ERROR = 'billing/SET_STATE_ERROR';
const SET_EMAIL_ERROR = 'billing/SET_EMAIL_ERROR';

// Pincode Methods
const LOAD_PINCODE = 'billing/LOAD_PINCODE';
const LOAD_PINCODE_SUCCESS = 'billing/LOAD_PINCODE_SUCCESS';
const LOAD_PINCODE_FAIL = 'billing/LOAD_PINCODE_FAIL';
const SET_PINCODE_QUERY = 'billing/SET_PINCODE_QUERY';
const SET_SELECTED_PINCODE = 'billing/SET_SELECTED_PINCODE';

const LOAD_PINCODE_DETAILS = 'billing/LOAD_PINCODE_DETAILS';
const LOAD_PINCODE_DETAILS_SUCCESS = 'billing/LOAD_PINCODE_DETAILS_SUCCESS';
const LOAD_PINCODE_DETAILS_FAIL = 'billing/LOAD_PINCODE_DETAILS_FAIL';
