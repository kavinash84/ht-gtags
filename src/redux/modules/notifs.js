const NOTIF_SEND = 'notifs/NOTIF_SEND';
const NOTIF_DISMISS = 'notifs/NOTIF_DISMISS';
const NOTIF_CLEAR = 'notifs/NOTIF_CLEAR';
const NOTIF_CLEAR_ALL = 'notifs/NOTIF_CLEAR_ALL';
