  ...
  <SectionHtV1 display="block" p="0" mb="0" height="auto">
    ...
    <ContainerHtV1 type="container" pr="0.5rem" pl="0.5rem">
      <BoxHtV1 className={styles.staticPageWrapper} type="block" pt="2rem" pb="2.5rem">
        ...
        <RowHtV1 ml="0" mr="0">
          <BoxHtV1>
            <TextHtV1 lineHeight="1.6" color="rgba(0,0,0,0.7)" fontSize="0.875rem" mb="1rem">
          ...
          <BoxHtV1>
            <HeadingHtV1 mb="1rem" fontFamily="medium" fontSize="1rem" color="text">
              Introduction
            </HeadingHtV1>
            <TextHtV1 lineHeight="1.6" color="rgba(0,0,0,0.7)" fontSize="0.875rem" mb="1rem">
          ...
          <BoxHtV1>
            ...
            <TextHtV1 lineHeight="1.6" color="rgba(0,0,0,0.7)" fontFamily="medium" fontSize="0.875rem" mb="0">
              You also agree to:
            </TextHtV1>
            <ol>
              <li>
          ...
          <BoxHtV1>
            ...
            <ol>
              <li>
                <TextHtV1 lineHeight="1.6" color="rgba(0,0,0,0.7)" fontSize="0.875rem" mb="0.5rem">
