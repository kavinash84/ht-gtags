...
@connect(
  ({ services, planyourkitchen }) => ({
    prefferedTime: planyourkitchen.data.items.text.prefferedTime,
    state: planyourkitchen.data.items.text.state,
    ...services.planyourkitchen
  }),
            ...
            >
              <Div p="20px 5px" mt="10px">
                <Div>
                  ...
                  >
                    Speak To Our Kitchen <br /> Experts
                  </Heading>
                </Div>
                <Div>
