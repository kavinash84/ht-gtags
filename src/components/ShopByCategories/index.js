...
const ShopByCategories = () => (
  <div p="16px 20px" mt="40px" pb="10px" style={{ float: 'none', display: 'block' }}>
    ...
    />
    <RowHtV1 justifyContent="space-around" style={{ width: '50%', margin: 'auto', display: 'flex' }}>
      ...
      <CategoryBlock
        ...
        style={{ height: ' 50px' }}
      />
      <CategoryBlock to="/furniture/living-room-furniture/recliners" src={shopByCat03} title="Recliners" />
      <CategoryBlock to="/furniture/dining-kitchen-furniture/dining-sets" src={shopByCat04} title="Dining Sets" />
      <CategoryBlock to="/furniture/bedroom-furniture/beds" src={shopByCat05} title="Beds" />
      <CategoryBlock to="/furniture/bedroom-furniture/wardrobes" src={shopByCat06} title="Wardrobes" />
      <CategoryBlock to="/furniture/shoe-racks" src={shopByCat07} title="Shoe Racks" />
      <CategoryBlock to="/furniture/book-shelves" src={shopByCat08} title="Book Shelves" />
      <CategoryBlock to="/home-decor" src={shopByCat09} title="Decor" />
      <CategoryBlock to="/tableware" src={shopByCat10} title="Tableware" />
      <CategoryBlock to="/home-furnishings" src={shopByCat11} title="Furnishings" />
      <CategoryBlock to="/kitchenware" src={shopByCat12} title="Kitchenware" />
    </RowHtV1>
  </div>
);
