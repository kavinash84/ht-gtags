...
class StepsToYourHome extends React.Component {
    ...
    render() { 
        const {
            stepsToDreamhome, loading, loaded
           } = this.props;
        return(
            <Div mt="70px">
              <Flex >
                  <Image src={stepsToDreamhome.image} style={{width: '55%', height: '750px'}}/>
                  <Div style={{width:'45%', height:'750px', backgroundColor: '#F5F5F5'}}>
        ...
        >
            <Div>
                    ...
                    fontSize="18px"
                fontFamily="medium"
                style={{ whiteSpace: 'normal', textAlign:'center', lineHeight:'30px'}}>
                    Thank You For Your <br /> Interest,  Our Team Will Get In Touch <br /> With You Shortly
                    </Heading>
                  </Div>
                  <img src={check} style={{width:'60px' , height:'60x', margin:'30px auto', display:'block'}} />
                  </Div>
                  </Div>
              </Flex>
            </Div>
