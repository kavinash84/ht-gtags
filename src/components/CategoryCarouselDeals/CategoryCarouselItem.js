    ...
    <Box p="10px" bg="white" style={{ position: 'relative', borderRadius: '5px', height: 'auto' }}>
      ...
      {image ? (
        <div style={{ position: 'relative' }}>
          <Image src={image} alt={name} height="auto" width="100%" m="auto" style={{ border: '2px solid #FAF4F2' }} />
      ...
      {hasCoupon ? (
        <Box style={{ display: 'flex', alignItems: 'center' }}>
          {percentageOff ? (
            <Text fontSize="0.7rem" mt="0px" mb="0px" mr="5px" mt="5px" style={{ fontWeight: 'bold' }}>
              {percentageOff}%Off
            </Text>
          ) : null}
          <Box
