    ...
    render() { 
        ...
        return (
            ...
            <Div style={{ width: '35%', margin: '30px 20px 10px' }}>
              <Link to={url_key1}>
              <Image data-src={image1} src={`${image1}?blur=30`} alt="outdoor" m={5} height="400px" width="100%" />
              <Text
                fontSize="22px"
                color="label"
                mt="10px"
            ...
            <Div style={{ width: '35%', margin: '30px 25px 10px' }}>
              <Link to={url_key2}>
              <Image data-src={image2} src={`${image2}?blur=30`} alt="outdoor" m={5} height="400px" width="100%" />
              <Text
                fontSize="20px"
                color="label"
                mt="10px"
