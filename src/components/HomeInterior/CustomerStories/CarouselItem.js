      ...
      <Div
          ...
          >
            <div className={styles.shadow}  style={{width: '100%',height: '400px' , backgroundColor:'white'}}>
              ...
              <Div col="6">
              <img src={data.imgSrc} style={{width:'48%', height:'500px', marginTop:'-50px', marginLeft:'100px'}}/>
              </Div>
              <Div col="6" style={{position:'absolute', left:'55%', top:'100px', textAlign: 'left'}} >
                   <Text style={{width:'60%', fontSize:'20px', fontWeight:'bold', lineHeight:'32px'}}>{data.description}</Text>
