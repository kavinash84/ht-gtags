    ...
    return (
      ...
      >
       <Div style={{ width:"90%", marginLeft:"5%" }}>
         <Image src="https://www.hometown.in/media/cms/designbuild/whychose.png"/>
       </Div>
       <Div>
         <Heading
         style={{
       ...
       <Div style={{height: '100%', width: '100%', backgroundColor:'#F8F2F2', display:'flex'}}>
        <Div style={{width:'30%' , paddingLeft: '10%', paddingTop:'90px'}}>
           <Heading style={{fontSize:'24px', textAlign:'left'}}>Living Room</Heading>
           <Text style={{fontSize:'16px', textAlign:'left', color:'#888888', width:'80%', lineHeight:'26px', marginTop:'15px'}}>As one of the largest design set-up with over 15 years of experience in home interiors, no one offers what we do</Text>
        </Div>
